...
require (
	...
	k8s.io/api v1.35.1
	k8s.io/apimachinery v1.35.1
	k8s.io/client-go v1.35.1
	k8s.io/component-base v1.35.1
	k8s.io/klog/v2 v2.130.1
	k8s.io/kube-scheduler v1.35.1
...
require (
	...
	k8s.io/apiextensions-apiserver v1.35.1 // indirect
	k8s.io/apiserver v0.35.1 // indirect
	k8s.io/cloud-provider v1.35.1 // indirect
	k8s.io/component-helpers v0.35.1 // indirect
	k8s.io/controller-manager v0.35.1 // indirect
	k8s.io/csi-translation-lib v1.35.1 // indirect
	k8s.io/dynamic-resource-allocation v1.35.1 // indirect
	k8s.io/kms v0.35.1 // indirect
	k8s.io/kube-openapi v0.0.0-20250910181357-589584f1c912 // indirect
	k8s.io/kubelet v0.35.1 // indirect
	k8s.io/utils v0.0.0-20251002143259-bc988d571ff4 // indirect
	sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.35.1 // indirect
