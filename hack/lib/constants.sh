...
function os::build::ldflags() {
  ...
  ldflags+=($(os::build::ldflag "k8s.io/kubernetes/pkg/version.majorFromGit" "${OS_GIT_MAJOR}"))
  ldflags+=($(os::build::ldflag "k8s.io/kubernetes/pkg/version.minorFromGit" "${OS_GIT_MINOR}"))
  ldflags+=($(os::build::ldflag "k8s.io/kubernetes/pkg/version.versionFromGit" "${OS_GIT_VERSION}"))
  ldflags+=($(os::build::ldflag "k8s.io/kubernetes/pkg/version.commitFromGit" "${OS_GIT_COMMIT}"))
  ldflags+=($(os::build::ldflag "k8s.io/kubernetes/pkg/version.buildDate" "${buildDate}"))
