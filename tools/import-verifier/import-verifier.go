...
const (
	rootPackage = "github.com/kubernetes-incubator/cluster-capacity"
)
...
func (i *ImportRestriction) isRestrictedPath(packageToCheck string) bool {
	...
	// github.com/kubernetes-incubator/cluster-capacity or github.com/kubernetes-incubator/cluster-capacity/vendor
